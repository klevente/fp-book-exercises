...
-- automatic versions for Eq, Ord, Show
derive instance eqMaybe :: Eq a => Eq (Maybe a)
derive instance ordMaybe :: Ord a => Ord (Maybe a)
derive instance genericMaybe :: Generic (Maybe a) _ -- second type parameter is `_`, needed for the compiler
instance showMaybe :: Show a => Show (Maybe a) where
    show = genericShow
...
type MyEitherVar = Either String (Maybe Int) -- create type alias so variables of this type can be created
